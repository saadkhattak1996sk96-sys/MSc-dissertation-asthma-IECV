# =====================================================================
# forest_plots_ge2_debray.R
#
# GE2 True Debray — forest plots for C-statistic and calibration slope
...
# in every fold by construction (see fit_ge2_debray_all_folds.R), so a
# plot of it would carry no information.
#
# Input:  ge2_debray_v3_all_folds_summary.rds,
#         ge2_debray_v3_pooled_bayesian_results.rds
# Output: GE2_debray_v3_forest_cstat.png, GE2_debray_v3_forest_slope.png
# =====================================================================
...
pooled <- readRDS("/users/hlskhatt/outputs/ge2_debray_v3_pooled_bayesian_results.rds")
...
p_cstat <- make_forest_plot(cstat_data, pooled$fit_cstat$est, pooled$fit_cstat$ci.lb, pooled$fit_cstat$ci.ub,
                             "GE2 True Debray (v3 folds) — C-statistic by Fold (IECV)", "C-statistic")
ggsave(file.path(output_dir, "GE2_debray_v3_forest_cstat.png"), p_cstat, width = 8, height = 5, dpi = 300)
...
p_slope <- make_forest_plot(slope_data, pooled$slope_summary["mu", "Median"],
                             ...
                             "GE2 True Debray (v3 folds) — Calibration Slope by Fold (IECV)", "Calibration Slope")
p_slope <- p_slope + geom_vline(xintercept = 1, linetype = "dashed", color = "grey50")
ggsave(file.path(output_dir, "GE2_debray_v3_forest_slope.png"), p_slope, width = 8, height = 5, dpi = 300)

cat("Saved: GE2_debray_v3_forest_cstat.png, GE2_debray_v3_forest_slope.png\n")
