# =====================================================================
# ge2_debray_meta_regression.R
#
# GE2 True Debray — exploratory meta-regression. Tests whether
# fold-level event rate or mean patient age explain the modest
# between-fold variation observed in discrimination and calibration.
#
...
# moderators) with no multiple-comparison correction — any
# "significant" result should be treated with corresponding caution.
#
# Input:  year1_ge_clean_v3.rds, ge2_debray_v3_all_folds_summary.rds
# Output: ge2_debray_v3_meta_regression_results.rds
# =====================================================================
...
# --- Explicit match()-based reorder after merge(), to guarantee
#     row alignment between fold-level results and fold-level
#     moderators regardless of merge()'s internal sort behaviour ---
...
cat("\n=== TRUE DEBRAY GE2 — META-REGRESSION (K=7, 4 tests, O:E excluded) ===\n")
print(summary_table)

saveRDS(list(fold_moderators = fold_moderators, summary_table = summary_table),
        "/users/hlskhatt/outputs/ge2_debray_v3_meta_regression_results.rds")
