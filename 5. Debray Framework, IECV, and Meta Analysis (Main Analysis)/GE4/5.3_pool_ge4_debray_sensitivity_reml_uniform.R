# =====================================================================
# pool_ge4_debray_sensitivity_reml_uniform.R
#
# GE4 True Debray — sensitivity comparison. Tests whether the pooled
...
# Output: ge4_debray_v3_sensitivity_comparison.rds
# =====================================================================
...
cat("--- Convergence check (psrf), C-statistic, uniform prior ---\n")
print(fit_cstat_unif$psrf)
...
cat("--- Convergence check (psrf), calibration slope, uniform prior ---\n")
print(fit_slope_unif$psrf)

# ---------------------------------------------------------------------
# Assemble and save the three-way comparison
# ---------------------------------------------------------------------
primary <- readRDS("/users/hlskhatt/outputs/ge4_debray_v3_pooled_bayesian_results.rds")$final_summary
...
cat("\n=== TRUE DEBRAY GE4 — SENSITIVITY COMPARISON ===\n")
print(comparison)

saveRDS(comparison, "/users/hlskhatt/outputs/ge4_debray_v3_sensitivity_comparison.rds")
